...
public class FriendService {
    ...
    public void acceptFriendRequest(String email, long memberId) {
        ...
        Friend friend = friendRepository.findByToMemberIdAndFromMemberIdAndAreWeFriends(toMember.getId(), memberId, false)
    ...
    public Page<MemberDTO> getFriendList(String email) {
        ...
        return friendRepository
                .findByToMemberIdOrFromMemberIdAndAreWeFriends(member.getId(), member.getId(), true)
                .map(friend -> {
